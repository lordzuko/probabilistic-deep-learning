...
#SBATCH --output=/work/tc046/tc046/lordzuko/work/probabilistic-deep-learning/logs/slurm-%A_output.out
...
cd /work/tc046/tc046/lordzuko/work/probabilistic-deep-learning
